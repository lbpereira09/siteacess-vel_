document.addEventListener('DOMContentLoaded', function () {
    ...
    mudacons.addEventListener('click', function () {
        ...
        const imgAtual = img.getAttribute('src');

        if (imgAtual.includes('cbjr-logo2.png')) {
            img.setAttribute('src', 'https://upload.wikimedia.org/wikipedia/commons/6/62/Cbjrlogo.png');
        } else {
            img.setAttribute('src', 'img/cbjr-logo2.png');
        }
    })
})
